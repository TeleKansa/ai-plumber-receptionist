...
def get_settings() -> Settings:
    return Settings(
        ...
        default_tenant_slug=os.getenv("DEFAULT_TENANT_SLUG", DEFAULT_TENANT_SLUG),
        default_tenant_greeting=os.getenv("DEFAULT_TENANT_GREETING", DEFAULT_TENANT_GREETING),
    )
